...
/**
 * @author Capgemini
 * This is the extension manager of the Solrsearchrestriction extension.
 */
public class SolrsearchrestrictionManager extends GeneratedSolrsearchrestrictionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SolrsearchrestrictionManager.class.getName());
	 ...
	 */
	public static SolrsearchrestrictionManager getInstance()
	{
		return (SolrsearchrestrictionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SolrsearchrestrictionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SolrsearchrestrictionManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SolrsearchrestrictionManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SolrsearchrestrictionManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SolrsearchrestrictionManager called, current tenant: " + getTenant().getTenantID());
		}
	}
