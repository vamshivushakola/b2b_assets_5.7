...
/**
 * This is the extension manager of the Productsearch extension.
 */
public class ProductsearchManager extends GeneratedProductsearchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductsearchManager.class.getName());
	 ...
	 */
	public static ProductsearchManager getInstance()
	{
		return (ProductsearchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductsearchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductsearchManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductsearchManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductsearchManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductsearchManager called, current tenant: " + getTenant().getTenantID());
		}
	}
