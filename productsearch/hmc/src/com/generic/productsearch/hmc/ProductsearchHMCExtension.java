 ...
 *  
 */
package com.generic.productsearch.hmc;
...
/**
 * Provides necessary meta information about the productsearch hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class ProductsearchHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ProductsearchHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.generic.productsearch.hmc.locales";
