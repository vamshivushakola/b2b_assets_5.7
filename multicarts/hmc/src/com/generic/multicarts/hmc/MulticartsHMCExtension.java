 ...
 *  
 */
package com.generic.multicarts.hmc;
...
/**
 * @author Capgemini
 * Provides necessary meta information about the multicarts hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class MulticartsHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MulticartsHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.generic.multicarts.hmc.locales";
