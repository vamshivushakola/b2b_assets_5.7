...
/**
 * This is the extension manager of the Multicarts extension.
 */
public class MulticartsManager extends GeneratedMulticartsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MulticartsManager.class.getName());
	 ...
	 */
	public static MulticartsManager getInstance()
	{
		return (MulticartsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MulticartsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MulticartsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MulticartsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MulticartsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MulticartsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
