...
/**
 * This is the extension manager of the Ordersearch extension.
 */
public class OrdersearchManager extends GeneratedOrdersearchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OrdersearchManager.class.getName());
	 ...
	 */
	public static OrdersearchManager getInstance()
	{
		return (OrdersearchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OrdersearchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OrdersearchManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OrdersearchManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OrdersearchManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OrdersearchManager called, current tenant: " + getTenant().getTenantID());
		}
	}
