...
<form:form action="${saveUrl}" id="b2BCostCenterform" commandName="b2BCostCenterForm" method="POST">
	...
	<ul class="form-list">
		...
		<li><formUtil:formInputBox idKey="text.company.costCenter.id.title" labelKey="text.company.costCenter.id.title" path="code" inputCSS="text" mandatory="true" /></li>
		<li><formUtil:formInputBox idKey="text.company.costCenter.name.title" labelKey="text.company.costCenter.name.title" path="name" inputCSS="text" mandatory="true" /></li>
		<li><formUtil:formSelectBox selectCSSClass="chosen-select-responsive select" idKey="text.company.costCenter.unit.title" skipBlank="true" labelKey="text.company.costCenter.unit.title" path="parentB2BUnit" mandatory="true" items="${b2bUnits}" /></li>
		<li><formUtil:formSelectBox selectCSSClass="chosen-select-responsive select" idKey="text.company.costCenter.currency.title" skipBlank="true" labelKey="text.company.costCenter.currency.title" path="currency" mandatory="true" items="${b2bCostCenterCurrencies}" /></li>
	</ul>
	<ycommerce:testId code="CC_cancel">
		<a href="${cancelUrl}" class="positive form no-confirm"><spring:theme code="text.company.costCenter.cancelButton.displayName" /></a>
	</ycommerce:testId>
	<ycommerce:testId code="CC_save">
