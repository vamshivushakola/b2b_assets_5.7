...
<%@ taglib prefix="formUtil" tagdir="/WEB-INF/tags/desktop/formElement"%>
 <ul class="form-list" id="billingCountrySelector" data-address-code="${cartData.deliveryAddress.id}" data-country-iso-code="${cartData.deliveryAddress.country.isocode}" data-display-title="false" class="clearfix">
	<li>
		<input type="hidden" value="${silentOrderPageData.parameters['billTo_email']}" class="text" name="billTo_email" id="billTo_email"> 
		<formUtil:formSelectBox icon="fa-building" idKey="address.country"
			                           ...
			                           itemValue="isocode"
			                           tabindex="${tabIndex}"
			                           selectCSSClass="chosen-select-responsive select" />
	</li> 
</ul>  
