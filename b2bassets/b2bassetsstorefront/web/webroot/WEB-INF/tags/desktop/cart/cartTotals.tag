...
<div class="totals">
	<table id="shopping-cart-totals-table" class="data-table">
		...
		</thead> commened by nam for cart page--%>
			<tr>
				<td class="a-right" colspan="1"><spring:theme code="basket.page.totals.subtotal" /></td>
				<td class="a-right last"><span class="price"><format:price priceData="${cartData.subTotal}" /></span></td>
			</tr>
			<c:if test="${cartData.totalDiscounts.value > 0}">
				<tr>
					<td class="a-right" colspan="1"><spring:theme code="basket.page.totals.savings" /></td>
					<td class="a-right last"><span class="price"><format:price priceData="${cartData.totalDiscounts}" /></span></td>
				</tr>
			</c:if>
			<c:if test="${not empty cartData.deliveryCost}">
				<tr>
