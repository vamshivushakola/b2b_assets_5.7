...
<script type="text/javascript">
	...
	var tabindex = 0;
	function AddProductTab(componentUid, componentTitle, componentContent,
			titleClass, contentClass) {
		PRODUCTTABSARRAY[tabindex++] = new ProductTab(componentUid,
				componentTitle, componentContent, titleClass, contentClass);
	};

	function ProductTab(componentUid, componentTitle, componentContent,
			titleClass, contentClass) {
...
<div id="prod_tabs">
	<ycommerce:testId code="productOptions_tabs">
		<ul class="resp-tabs-list" id="tab_strip">
			<li id="tab_01"><spring:theme code="product.product.details" /></li>
			<li class="tab_03"><spring:theme code="review.reviews" /></li>
		</ul>
	</ycommerce:testId>
