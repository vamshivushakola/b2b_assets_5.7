	...
	<c:choose>
		<c:when test="${not empty searchPageData.results}">
			<nav:pagination top="true" supportShowPaged="${isShowPageAllowed}"
				...
				searchUrl="/my-account/approval-dashboard?sort=${searchPageData.pagination.sort}"
					...
					<thead>
						<tr>
							<th id="header1"><spring:theme
									code="text.account.orderApprovalDashBoard.orderNumber"
									text="Order Number" /></th>
							<th id="header2"><spring:theme
									code="text.account.order.purchase" text="Purchaser" /></th>
							<th id="header3"><spring:theme
									code="text.account.orderApprovalDashBoard.purchaseOrderNumber"
									text="P.O.No" /></th>
							<th id="header4"><spring:theme
									code="text.account.orderApprovalDashBoard.orderCreated"
									text="Order Created" /></th>
							<th id="header5"><spring:theme
									code="text.account.orderApprovalDashBoard.orderStatus"
									text="Order Status" /></th>
							<th id="header6"><spring:theme
									code="text.account.orderApprovalDashBoard.actions"
									text="Actions" /></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${searchPageData.results}" var="order">
							<tr>
								<td headers="header1"><ycommerce:testId
										...
										<a
											href="orderApprovalDetails/${order.workflowActionModelCode}">${order.b2bOrderData.code}</a>
									</ycommerce:testId></td>
								...
								<td headers="header6"><ycommerce:testId
										code="orderApprovalDashboard_Actions_links">
										<ul class="updates">
											<li><a
												href="orderApprovalDetails/${order.workflowActionModelCode}"><spring:theme
														code="text.view" text="View" /></a></li>
										</ul>
									</ycommerce:testId></td>
							</tr>
						</c:forEach>
