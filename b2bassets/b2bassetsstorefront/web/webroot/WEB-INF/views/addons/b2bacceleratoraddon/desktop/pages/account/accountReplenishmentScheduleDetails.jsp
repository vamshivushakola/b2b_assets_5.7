...
<span id="replenishment_confirmaton_number"> <spring:theme code="order.replenishment.confirmation.number" arguments="${scheduleData.jobCode}" />
					</span> <br />
					<c:if test="${not scheduleData.active}">
						<spring:theme code="text.account.replenishment.orderStatus" text="Order Status" />:
					...
					<c:if test="${scheduleData.active}">
						<spring:url value="/my-account/my-replenishment/detail/confirmation/cancel/${scheduleData.jobCode}/" var="cancelReplenishmentUrl" />
						<div class="last">
							<a href="${cancelReplenishmentUrl}"> <ycommerce:testId code="replenishmentHistory_cancel_link">
