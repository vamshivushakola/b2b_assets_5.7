		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<h2>
						<spring:theme code="text.company.managePermissions.create.permission.title" text="Create Permission" />
					</h2>
					<p class="required">
					...
					<form:form id="b2BPermissionTypeSelectionForm" commandName="b2BPermissionTypeSelectionForm" method="POST">
						<ul class="form-list">
							<li><formUtil:formSelectBox selectCSSClass="chosen-select-responsive select" idKey="text.company.managePermissions.type.label" labelKey="text.company.managePermissions.type.label" skipBlankMessageKey="text.company.managePermissions.selectBox.permissionType" mandatory="true" path="b2BPermissionType" items="${ b2bPermissionTypes}" /></li>
						</ul>
						<button type="submit" class="positive continue">
							<spring:theme code="text.company.managePermissions.create.continueButton" text="Continue" />
						</button>
						<a href="${cancelUrl}" class="positive cancel"><spring:theme code="text.company.managePermissions.edit.cancelButton" text="Cancel" /></a>
					</form:form>
				</div>
			</div>
		</div>
