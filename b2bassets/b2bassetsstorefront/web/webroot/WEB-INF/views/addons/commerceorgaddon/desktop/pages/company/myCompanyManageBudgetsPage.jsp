		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<h2 class="subtitle">
						<spring:theme code="text.company.manage.budget.title" text="All Budgets" />
					</h2>

					<spring:theme code="text.company.manage.budget.subtitle" arguments="${b2bStore}" />
					<div class="budget-div"> <!-- added class name "budget-div" for css changes -->
						<a href="${addBudgetUrl}" class="positive create-budget"><spring:theme code="text.company.budget.createButton.displayName" /></a>
					</div>
					<nav:pagination top="true" supportShowPaged="${isShowPageAllowed}" supportShowAll="${isShowAllAllowed}" searchPageData="${searchPageData}" searchUrl="/my-company/organization-management/manage-budgets?sort=${searchPageData.pagination.sort}" msgKey="text.company.budget.page" numberPagesShown="${numberPagesShown}" />
							...
							<c:forEach items="${searchPageData.results}" var="b2bBudget">
								...
								<tr>
									...
									<td><ycommerce:testId code="budget_unit_label">
											...
											<span>
												<a href="${unitDetailsUrl}">${b2bBudget.unit.name}</a>
											</span>
										</ycommerce:testId></td>
									<td><ycommerce:testId code="budget_unit_label">
											<span class="hidden-lg hidden-md hidden-sm mobile-label"> 
									...
									<td><ycommerce:testId code="budget_startDate_label">
											<span class="hidden-lg hidden-md hidden-sm mobile-label"> 
												<spring:theme code="text.company.budget.start" text="Start" /> : 
											</span>
											<span>
									...
									<td><ycommerce:testId code="budget_endDate_label">
											<span class="hidden-lg hidden-md hidden-sm mobile-label"> 
												<spring:theme code="text.company.budget.end" text="End" /> : 
											</span>
											<span>
									...
									<td><ycommerce:testId code="budget_currency_label">
											<span class="hidden-lg hidden-md hidden-sm mobile-label">
												<spring:theme code="text.company.budget.currency" text="Currency" /> : 
											</span>
									...
									<td class="last"><ycommerce:testId code="budget_status_label">
											<span class="hidden-lg hidden-md hidden-sm mobile-label">
