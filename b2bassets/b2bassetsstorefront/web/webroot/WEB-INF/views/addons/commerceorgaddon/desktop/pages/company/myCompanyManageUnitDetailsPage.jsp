			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="last margin-bottom-10">
						<a href="${editUnitUrl}" class="positive edit"> <spring:theme code="text.company.manage.units.button.editUnit" text="Edit Unit" />
						</a>
						<c:choose>
							<c:when test="${unit.active}">
								<c:if test="${unit.uid != user.unit.uid}">
									<ycommerce:testId code="Unit_DisableUnit_button">
										<a href="${disableUnitUrl}" class="positive disable"> <spring:theme code="text.company.manage.units.button.disableUnit" text="Disable Unit" />
										</a>
									</ycommerce:testId>
								</c:if>
							</c:when>
							<c:otherwise>
								<c:choose>
									<c:when test="${unit.unit.active}">
										<ycommerce:testId code="Unit_EnableUnit_button">
											<a href="${enableUnitUrl}" class="positive enable"> <spring:theme code="text.company.manage.units.button.enableUnit" text="Enable Unit" />
											</a>
										</ycommerce:testId>
									</c:when>
									<c:otherwise>
										<spring:theme code="text.company.manage.units.parentUnit.disabled" text="It is not possible to enable unit whose parent unit is disabled" />
									</c:otherwise>
								</c:choose>
							</c:otherwise>
						</c:choose>
					...
					<ul>
						<li><strong><ycommerce:testId code="Unit_UnitDetailsPage_UnitID">
									<spring:theme code="text.company.unit.id" text="Business Unit ID : " />
								</ycommerce:testId></strong> <ycommerce:testId code="Unit_UnitDetailsPage_UnitID">${unit.uid}</ycommerce:testId></li>
						<li><strong><spring:theme code="text.company.unit.name" text="Business Unit Name : " /></strong>${unit.name}</li>
						<li><strong><spring:theme code="text.company.unit.parent" text="Parent Business Unit : " /></strong>${unit.unit.uid}</li>
						<li><strong><spring:theme code="text.company.unit.approvalProcess" text="Approval Process : " /></strong>${unit.approvalProcessName}</li>
					</ul>
					<h2 class="subtitle">
					...
					<table class="data-table quote-status-details-table">
						<thead>
							<tr>
								<th><spring:theme code="text.company.manage.units.accountManager.name" text="Name" /></th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${unit.accountManagers}" var="accountManager">
								<tr>
									<td class="last">${accountManager.name}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					...
					<div class="last margin-bottom-10">
						<ycommerce:testId code="Unit_AddAddress_button">
							<a href="${addUnitAddressUrl}" class="positive create"> <spring:theme code="text.company.manage.units.button.create" text="Create" />
							</a>
						</ycommerce:testId>
					</div>
					<table class="data-table quote-status-details-table">
						<thead>
							<tr class="hidden-xs">
								<th><spring:theme code="text.company.manage.units.address.line1" text="Address Line 1" /></th>
								<th><spring:theme code="text.company.manage.units.address.line2" text="Address Line 2" /></th>
								<th><spring:theme code="text.company.manage.units.address.towncity" text="Town/City" /></th>
								<th><spring:theme code="text.company.manage.units.address.zipcode" text="Postal Code" /></th>
								<th><spring:theme code="text.company.manage.units.address.country" text="Country" /></th>
								<th><spring:theme code="text.company.manage.units.address.actions" text="Actions" /></th>
							</tr>
							<tr class="hidden-lg hidden-md hidden-sm">
								<th><spring:theme code="text.company.manage.units.addresses" text="Addresses" /></th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${unit.addresses}" var="address">
								<tr>
									<spring:url value="/my-company/organization-management/manage-units/edit-address/" var="editUnitAddressUrl">
										<spring:param name="unit" value="${unit.uid}" />
										<spring:param name="addressId" value="${address.id}" />
									</spring:url>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.units.address.line1" text="Address Line 1" /> : </span>${address.line1}</td>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.units.address.line2" text="Address Line 2" /> : </span>${address.line2}</td>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.units.address.towncity" text="Town/City" /> : </span>${address.town}</td>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.units.address.zipcode" text="Postal Code" /> : </span>${address.postalCode}</td>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.units.address.country" text="Country" /> : </span>${address.country.name}</td>
									<td class="last"><spring:url value="/my-company/organization-management/manage-units/remove-address/" var="removeUnitAddressUrl">
											<spring:param name="unit" value="${unit.uid}" />
											<spring:param name="addressId" value="${address.id}" />
										</spring:url>
										<ul class="updates clear_fix">
											<li><a title="<spring:theme code="text.company.manage.units.edit" text="Edit" />" class="edit-address" href="${editUnitAddressUrl}"></a></li>
											<li><a title="<spring:theme code="text.company.manage.units.remove" text="Remove" />" class="remove-address" href="${removeUnitAddressUrl}"></a></li>
										</ul></td>
								</tr>
							</c:forEach>
						</tbody>
					...
					<div class="last margin-bottom-10">
						<a href="${addCostcenterUrl}" class="positive create"> <spring:theme code="text.company.manage.units.button.create" text="Create" />
						</a>
					</div>
					<p>
						<spring:theme code="text.company.manage.units.view.costCenters.subtitle" />
					...
					<table class="data-table quote-status-details-table">
						<thead>
							<tr class="hidden-xs">
								<th><spring:theme code="text.company.manage.unit.costCenter.id" text="ID" /></th>
								<th><spring:theme code="text.company.manage.unit.costCenter.name" text="Name" /></th>
								<th><spring:theme code="text.company.manage.unit.costCenter.currency" text="Currency" /></th>
								<th><spring:theme code="text.company.manage.unit.costCenter.actions" text="Actions" /></th>
							</tr>
							<tr class="hidden-lg hidden-md hidden-sm">
						...
						<tbody>
							<c:forEach items="${unit.costCenters}" var="b2bCostCenter">
								<spring:url value="/my-company/organization-management/manage-units/costcenter/" var="viewCostcenterUrl">
									<spring:param name="unit" value="${unit.uid}" />
									<spring:param name="costCenterCode" value="${b2bCostCenter.code}" />
								</spring:url>

								<spring:url value="/my-company/organization-management/manage-units/editcostcenter/" var="editCostcenterUrl">
									<spring:param name="unit" value="${unit.uid}" />
									<spring:param name="costCenterCode" value="${b2bCostCenter.code}" />
								</spring:url>

								<tr>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.unit.costCenter.id" text="ID" /> : </span><a href="${viewCostcenterUrl}">${b2bCostCenter.code}</a></td>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.unit.costCenter.name" text="Name" /> : </span>${b2bCostCenter.name}</td>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.unit.costCenter.currency" text="Currency" /> : </span>${b2bCostCenter.currency.name}</td>
									<td class="last">
										<ul class="updates clear_fix">
											<li><a href="${editCostcenterUrl}" class="edit-address" title="<spring:theme code="text.company.manage.unit.costCenter.edit" text="Edit" />"> </a></li>
										</ul>
									</td>
								</tr>
							</c:forEach>
					...
					<div class="last margin-bottom-10">
						<a href="${createUnitUrl}" class="positive create"> <spring:theme code="text.company.manage.units.button.create" text="Create" />
						</a>
					</div>
					<p>
						<spring:theme code="text.company.manage.units.view.units.subtitle" />
					...
					<table class="data-table quote-status-details-table">
						<thead>
							<tr class="hidden-xs">
								<th><spring:theme code="text.company.manage.units.childrenUnits.id" text="ID" /></th>
								<th><spring:theme code="text.company.manage.units.childrenUnits.name" text="Name" /></th>
								<th><spring:theme code="text.company.manage.units.childrenUnits.actions" text="Actions" /></th>
							</tr>
							<tr class="hidden-lg hidden-md hidden-sm">
								<th><spring:theme code="text.company.manage.units.childUnits" text="Child Units" /></th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${unit.children}" var="unit">
								...
								<spring:url value="/my-company/organization-management/manage-units/edit" var="editUnit">
									<spring:param name="unit" value="${unit.uid}" />
								</spring:url>
								<tr>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.units.childrenUnits.id" text="ID" /> : </span><a href="${unitUrl}">${unit.uid}</a></td>
									<td><span class="hidden-lg hidden-md hidden-sm mobile-label"><spring:theme code="text.company.manage.units.childrenUnits.name" text="Name" /> : </span>${unit.name}</td>
									<td class="last">
										<ul class="updates clear_fix">
											<li><a href="${editCostcenterUrl}" class="edit-address" title="<spring:theme code="text.company.manage.unit.childrenUnits.edit" text="Edit" />"> </a></li>
										</ul>
									</td>
								</tr>
							</c:forEach>
					...
					<spring:url value="/my-company/organization-management/manage-units/managers" var="editManagersUrl">
						<spring:param name="unit" value="${unit.uid}" />
						<spring:param name="role" value="b2bmanagergroup" />
					</spring:url>
					<spring:url value="/my-company/organization-management/manage-units/approvers" var="editApproversUrl">
						<spring:param name="unit" value="${unit.uid}" />
					</spring:url>
					...
					<company:approverList users="${unit.approvers}" role="b2bapprovergroup" editUrl="${editApproversUrl}" createUrl="${createUserUrl}" />

					<company:userList users="${unit.administrators}" action="administrators" role="b2badmingroup" editUrl="${editAdministratorUrl}" createUrl="${createUserUrl}" subtitleKey="text.company.manage.units.view.administrators.subtitle" />

					<company:userList users="${unit.managers}" action="managers" role="b2bmanagergroup" editUrl="${editManagersUrl}" createUrl="${createUserUrl}" subtitleKey="text.company.manage.units.view.managers.subtitle" />

					<company:userList users="${unit.customers}" action="customers" role="b2bcustomergroup" editUrl="${editCustomersUrl}" createUrl="${createUserUrl}" subtitleKey="text.company.manage.units.view.customers.subtitle" />
				</div>
			</div>
		</div>
	</div> 
