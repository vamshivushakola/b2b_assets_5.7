...
<spring:url value="/my-company/organization-management/manage-costcenters/disable" var="confirmDisableUrl">
	<spring:param name="costCenterCode" value="${costCenterCode}" />
</spring:url>
<spring:url value="/my-company/organization-management/manage-costcenters/view" var="cancelDisableUrl">
	<spring:param name="costCenterCode" value="${costCenterCode}" />
</spring:url>
	...
	<div class="main-content account-page">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					<h2 class="subtitle">
						<spring:theme code="text.company.costCenter.disable.confirm" text="Confirm Disable" />
					</h2>
					<form:form action="${confirmDisableUrl}" id="confirmDisableCostCenter">
						<ycommerce:testId code="cancelCCdisable">
							<a href="${cancelDisableUrl}" class="positive no-confirm"><spring:theme code="text.company.costCenter.disable.confirm.no" /></a>
						</ycommerce:testId>
						<ycommerce:testId code="confirmCCdisable">
