...
<spring:url value="/my-company/organization-management/manage-usergroups/remove" var="removeUrl">
	<spring:param name="usergroup" value="${usergroup.uid}" />
</spring:url>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<h2 class="subtitle">
						<spring:theme code="text.company.manageUsergroups.remove" text="Confirm Remove" arguments="${usergroup.uid}" />
					</h2>
					<p>
						<spring:theme code="text.company.manageUsergroups.remove.confirmation" text="Doing this will remove User Group : {0} . Do you want to proceed?" arguments="${usergroup.uid}" />
					</p>

					<form:form action="${removeUrl}" id="confirmRemoveUserGroup">
