...
<%@ taglib prefix="breadcrumb" tagdir="/WEB-INF/tags/desktop/nav/breadcrumb"%>
		...
		<h2 class="subtitle">
					...
					<form:form action="update-password" method="post" commandName="updatePasswordForm" autocomplete="off">
						<ul class="form-list">
							<li><formUtil:formPasswordBox icon="fa-lock" idKey="profile.currentPassword" labelKey="profile.currentPassword" path="currentPassword" labelCSS="password" inputCSS="text password" mandatory="true" /></li>
							<li><formUtil:formPasswordBox icon="fa-lock" idKey="profile-newPassword" labelKey="profile.newPassword" path="newPassword" labelCSS="password" inputCSS="text password strength" mandatory="true" /></li>
							<li><formUtil:formPasswordBox icon="fa-lock" idKey="profile.checkNewPassword" labelKey="profile.checkNewPassword" path="checkNewPassword" labelCSS="password" inputCSS="text password" mandatory="true" /></li>
						</ul>
						<button class="form">
							<spring:theme code="text.account.profile.updatePasswordForm" text="Update Password" />
						</button>
