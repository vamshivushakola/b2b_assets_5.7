...
<c:set value="${component.styleClass} ${dropDownLayout}" var="bannerClasses"/>
<li class="menu dropdown yamm-fw ${bannerClasses}">
	<cms:component component="${component.link}" evaluateRestriction="true" />
	<c:if test="${not empty component.navigationNode.children}">
		<a href="#" class="dropdown-toggle cross hidden-md hidden-lg" data-toggle="dropdown"></a>
		<a href="#" class="dropdown-toggle arrow hidden-xs hidden-sm" data-toggle="dropdown"></a>
