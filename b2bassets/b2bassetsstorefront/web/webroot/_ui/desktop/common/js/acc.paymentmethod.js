ACC.paymentmethod = {
		...
		$('div.checkout_summary_flow_b .change_payment_method_button').click(function ()
		{
			...
			var options = {
				...
				success: function (data)
				{
					...
					$.colorbox({inline: true, href: "#popup_checkout_add_edit_payment_method", width:"95%", height: false, overlayClose: false});
		...
		$('button.use_saved_card_button').click(function ()
		{
			$.ajax({
				...
				success: function (data)
				{
					...
					$.colorbox({inline: true, href: "#popup_checkout_saved_payment_method", width:"95%", height: false});
				},
				error: function (xht, textStatus, ex)
				{
	...
	bindEnterNewPaymentButton: function ()
	{
		...
		{
			// Show the payment method popup
			$.colorbox({inline: true, href: "#popup_checkout_add_edit_payment_method", width:"95%", height: false});
			return false;
		});
	},
