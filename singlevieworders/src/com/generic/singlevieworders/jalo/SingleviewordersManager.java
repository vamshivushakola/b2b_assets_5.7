...
/**
 * This is the extension manager of the Singlevieworders extension.
 */
public class SingleviewordersManager extends GeneratedSingleviewordersManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SingleviewordersManager.class.getName());
	 ...
	 */
	public static SingleviewordersManager getInstance()
	{
		return (SingleviewordersManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SingleviewordersConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SingleviewordersManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SingleviewordersManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SingleviewordersManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SingleviewordersManager called, current tenant: " + getTenant().getTenantID());
		}
	}
