 ...
 *
 */
package com.generic.singlevieworders.hmc;
...
/**
 * Provides necessary meta information about the singlevieworders hmc extension.
 * 
 * 
 * @version ExtGen v5.7.0.0-SNAPSHOT
 */
public class SingleviewordersHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SingleviewordersHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.generic.singlevieworders.hmc.locales";
