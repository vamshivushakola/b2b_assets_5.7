 ...
 *  
 */
package com.capgemini.quickorder.hmc;
...
/**
 * Provides necessary meta information about the quickorder hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class QuickorderHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(QuickorderHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.capgemini.quickorder.hmc.locales";
